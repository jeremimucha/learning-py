...
# Test via monkeypatching the entire `get_path` function
...
# Test via replacing pathlib.Path.home()
def test_patch_home(monkeypatch, tmp_path):
    ...
    # Notice we're patching the pathlib.Path already imported by cards.cli
