...
import moviedata
import ui_addeditmoviedlg_ex


class AddEditMovieDlg(QDialog, ui_addeditmoviedlg_ex.Ui_AddEditMovieDlg):
    ...
    def __init__(self, movies, movie=None, parent=None):
        ...
        if movie is not None:
            ...
            self.location_ledit.setText(movie.location)
    ...
    def accept(self):
        ...
        location = self.location_ledit.text()
