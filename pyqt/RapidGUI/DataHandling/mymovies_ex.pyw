...
import platform
import sys
from PyQt5.QtCore import QFile, QSettings, QByteArray, Qt, QFileInfo, QTimer
from PyQt5.QtGui import QKeySequence, QIcon
from PyQt5.QtWidgets import (QMainWindow, QTableWidget, QTableWidgetItem, QShortcut, QAction,
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.movies = moviedata_ex.MovieContainer()
        ...
        #         self.editEdit)
        self.table.itemDoubleClicked['QTableWidgetItem*'].connect(self.editEdit)
    ...
    def updateTable(self, current=None):
        ...
        for row, movie in enumerate(self.movies):
            ...
            item = QTableWidgetItem(movie.acquired.toString(moviedata_ex.DATEFORMAT))
            item.setTextAlignment(Qt.AlignRight|Qt.AlignVCenter)
            self.table.setItem(row, 3, item)
            location = movie.location
            if location != movie.UNKNOWNLOCATION:
                item = QTableWidgetItem("{}".format(location))
                item.setTextAlignment(Qt.AlignCenter)
