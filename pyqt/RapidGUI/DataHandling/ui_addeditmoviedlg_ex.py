...
class Ui_AddEditMovieDlg(object):
    def setupUi(self, AddEditMovieDlg):
        ...
        self.location_lbl = QtWidgets.QLabel("&Location")
        self.location_ledit = QtWidgets.QLineEdit(AddEditMovieDlg)
        self.location_ledit.setObjectName("locationLineEdit")
        self.gridlayout.addWidget(self.location_lbl, 3, 0, 1, 2)
        self.gridlayout.addWidget(self.location_ledit, 3, 2, 1, 4)
        self.location_lbl.setBuddy(self.location_ledit)
