...
from PyQt5.QtCore import Qt, QSettings, QFile, QByteArray, QTimer
from PyQt5.QtGui import QImage, QIcon, QKeySequence, QPixmap, QImageReader
from PyQt5.QtWidgets import (QApplication, QMainWindow, QLabel, QDockWidget, QListWidget, QFrame, QAction,
                            QActionGroup, QMessageBox, QFileDialog, QSpinBox, QInputDialog)
import helpform
import newimagedlg
import resizedlg
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # QPrinter created only if needed, once created a reference is maintained to avoid garbage collection
        self.printer = None
        ...
        # edit toolbar has a spinbox added for convenience
        editToolbar = self.addToolBar("Edit")
        editToolbar.setObjectName("EditToolBar")
        self.addActions(editToolbar, (editInvertAction,
                editSwapRedAndBlueAction, editUnMirrorAction,
                editMirrorVerticalAction, editMirrorHorizontalAction, editResizeAction))
    ...
    def updateFileMenu(self):
        ...
        recentFiles = [fname for fname in self.recentFiles
                        if fname != current and QFile.exists(fname)]
        if recentFiles:
...
if __name__ == "__main__":
    def main():
        ...
        app.setOrganizationName("Banan Ltd.")
        app.setOrganizationDomain("bananus.com")
        app.setApplicationName("Image Changer")
        app.setWindowIcon(QIcon(":/icon.png"))
        # app.setFallbacksEnabled(False)
        form = MainWindow()
        form.show()
        app.exec_()
