...
from PyQt5.QtWidgets import (QDialog, QLabel, QTableView, QPushButton,
    QHBoxLayout, QVBoxLayout, QSplitter, QWidget, QMessageBox, QApplication)
import ships
...
class MainForm(QDialog):
    ...
    def initialLoad(self):
        if not QFile.exists(self.model.filename):
            ...
            # self.model.reset()
            # reset() method is obsolete
            # insead the beginResetModel() and endResetModel() are used
