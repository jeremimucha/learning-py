...
import collections
import sys
from PyQt5.QtCore import (Qt, QDir, QReadWriteLock, QReadLocker, QWriteLocker)
# from PyQt5.QtGui import ()
from PyQt5.QtWidgets import (QDialog, QApplication, QLabel, QPushButton,
    QLineEdit, QListWidget, QLCDNumber, QFrame, QHBoxLayout, QVBoxLayout,
    QFileDialog)
...
class Form(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.walker.indexed['QString'].connect(self.indexed)
        self.walker.finished[bool].connect(self.finished)
