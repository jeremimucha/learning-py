...
import stat
import sys
from PyQt5.QtCore import (Qt, QProcess, QSettings, QDir, QFile, QT_VERSION_STR, PYQT_VERSION_STR,)
from PyQt5.QtGui import (QCursor)
from PyQt5.QtWidgets import (QApplication, QMainWindow, QDialog, QLabel,
    QPushButton, QWidget, QRadioButton, QCheckBox, QDialogButtonBox, QFrame,
    QTextBrowser, QTextEdit, QMenu, QFileDialog, QGroupBox, QMessageBox, 
...
if sys.platform.startswith("darwin"):
    ...
    if i > -1:
        PYUIC5 = PYUIC5[:i] + "Lib/python2.6/site-packages/PyQt4/uic/pyuic.py"
